# 1 "L07_main_serialCommunication.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "L07_main_serialCommunication.c" 2
...
# 9 "L07_main_serialCommunication.c" 2


# 1 "./../../Libraries/PLIB_USART.h" 1
# 40 "./../../Libraries/PLIB_USART.h"
union USART1
{
  unsigned char val;
  struct
...
# 11 "L07_main_serialCommunication.c" 2
...
# 16 "L07_main_serialCommunication.c" 2
...
# 41 "L07_main_serialCommunication.c"
...
void __attribute__((picinterrupt(("high_priority")))) high_isr(void){
    ...
    if(PIE1bits.ADIE && PIR1bits.ADIF){
        ...
        unsigned int val = (unsigned int) ((unsigned long)ADRES * 4750) / 1023;
...
void adc_to_LCD(unsigned int val){
    while(LCD_Busy()){;} LATAbits.LATA5 = 0; LCD_Write(0x01); _delay((unsigned long)((5)*(4000000/4000.0)));
        ...
        LCD_ValueOut_00(0, 0, val, 4);
        LCD_ConstTextOut(0, 4, " mV");
...
void __init(void) {
    ...
    TRISCbits.TRISC6 = 1 ;
    TRISCbits.TRISC7 = 1 ;
# 211 "L07_main_serialCommunication.c"
    TXSTA1bits.SENDB = 0;



    unsigned char config = 0b11111101 & 0b11111110 & 0b11111111 & 0b11111111 & 0b01111111;
    unsigned int spbrg = 51;
    Open1USART(config, spbrg);
    BAUDCON1 = 0b11111111 & 0b11011111 & 0b11101111 & 0b11111110 & 0b11111101;
