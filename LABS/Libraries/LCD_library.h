...
// ein easteregg:
#define lol() if(adcresult==0){LCD_ConstTextOut(1,0,"zu klein");}else{if(adcresult>4990){LCD_ConstTextOut(1,0,"zu hoch!  ");}else{if(adcresult>2400 && adcresult<2600 ){LCD_ConstTextOut(1,0,"chillig");}else{LCD_ConstTextOut(1,0,"");}}}
