...
# 2 "<built-in>" 2
# 1 "../../Libraries/GLCD_library.c" 2
# 20 "../../Libraries/GLCD_library.c"
# 1 "../../Libraries/GLCD_library.h" 1
# 11 "../../Libraries/GLCD_library.h"
# 1 ".\\GLCD_config.h" 1
# 11 ".\\GLCD_config.h"
...
void GLCD_Write(unsigned char data, unsigned char dc)
{
    ...
    LATAbits.LATA5 = dc;
    LATCbits.LATC1 = 0;
    LATCbits.LATC3 = 0; LATCbits.LATC5 = spiData.bit7; ; LATCbits.LATC3 = 1; ;
    LATCbits.LATC3 = 0; LATCbits.LATC5 = spiData.bit6; ; LATCbits.LATC3 = 1; ;
    LATCbits.LATC3 = 0; LATCbits.LATC5 = spiData.bit5; ; LATCbits.LATC3 = 1; ;
    LATCbits.LATC3 = 0; LATCbits.LATC5 = spiData.bit4; ; LATCbits.LATC3 = 1; ;
    LATCbits.LATC3 = 0; LATCbits.LATC5 = spiData.bit3; ; LATCbits.LATC3 = 1; ;
    LATCbits.LATC3 = 0; LATCbits.LATC5 = spiData.bit2; ; LATCbits.LATC3 = 1; ;
    LATCbits.LATC3 = 0; LATCbits.LATC5 = spiData.bit1; ; LATCbits.LATC3 = 1; ;
    LATCbits.LATC3 = 0; LATCbits.LATC5 = spiData.bit0; ; LATCbits.LATC3 = 1; ;
    LATCbits.LATC1 = 1;
}
...
void GLCD_Init(void)
{
    TRISAbits.TRISA5 = TRISCbits.TRISC0 = TRISCbits.TRISC1 = TRISCbits.TRISC3 = TRISCbits.TRISC5 = 0;

    LATCbits.LATC0 = 0;
    __nop();__nop();__nop();__nop();__nop();__nop();
    LATCbits.LATC0 = 1;

    GLCD_Write(0x20 | 0x01, 0);
    GLCD_Write(0x80 | 0x40, 0);
    GLCD_Write(0x04 | 0x02, 0);
    GLCD_Write(0x10 | 0x02, 0);
    GLCD_Write(0x20 | 0x00 | 0x00 | 0x00, 0);
    GLCD_Write(0x08 | 0x04, 0);
...
void GLCD_ClearRow(unsigned char row)
{
    ...
    GLCD_Write(0x80 | 0, 0); GLCD_Write(0x40 | row, 0);;
...
char GLCD_CharOut(unsigned char row, unsigned char col, unsigned char c)
{
    ...
    if((row > 5) || (col > 78)) return 0x00;

    GLCD_Write(0x80 | col, 0); GLCD_Write(0x40 | row, 0);;
...
{
    GLCD_Write(0x80 | col*6, 0); GLCD_Write(0x40 | row, 0);;
    while (*text) {
        GLCD_WriteChar(*text);
        text++;
    }
 ...
 char GLCD_Char2Out(unsigned char row, unsigned char col, unsigned char c)
{
    ...
    if((row > 2) || (col > 78)) return 0x00;

    GLCD_Write(0x80 | col, 0); GLCD_Write(0x40 | row*2, 0);;
    ...
    GLCD_Write(0x80 | col, 0); GLCD_Write(0x40 | row*2 + 1, 0);;
                    ...
                    unsigned char row_top, unsigned char col_left)
{
    ...
    for(r = 0; r < rows; r++){
        GLCD_Write(0x80 | col_left, 0); GLCD_Write(0x40 | row_top +r, 0);;
        for (c = 0; c < columns; c++){
            GLCD_Write(*bm++, 1);
        }
    }
